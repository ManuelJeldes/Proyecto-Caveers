...
const $card = document.querySelectorAll('.tarjetas');

$card.forEach((card) => {
    // Acceder al elemento de título dentro de la carta
    const tituloCarrera = card.querySelector('.name-career-faceback');
    ...
    if (tituloCarrera) {
        ...
        if (nombreEspecifico) {
            ...
            const imagenElement = card.querySelector('.img-faceback');
            if (imagenElement) {
